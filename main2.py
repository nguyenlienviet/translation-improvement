...
def _main(_):
    # Data
    train_data = tx.data.PairedTextData(hparams=config.train_data)
    val_data = tx.data.PairedTextData(hparams=config.val_data)
    test_data = tx.data.PairedTextData(hparams=config.test_data)
